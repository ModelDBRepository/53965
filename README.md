...
The package contains mechanisms (.mod files) and programs (.oc files) needed to simulate different models of thalamic reticular (RE) neurons, relative to the paper:
...
[http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=pubmed&dopt=Abstract&list_uids=8613783&query_hl=7](http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Retrieve&db=pubmed&dopt=Abstract&list_uids=8613783&query_hl=7)
...
After either of the above platform instructions:
